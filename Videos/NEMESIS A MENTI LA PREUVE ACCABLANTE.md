...
1. **Preuve documentaire du guet-apens prémédité** : *L'Humanité* publie des conversations internes entre Ornela (Némésis Lyon) et Calixy ([[Audace Lyon]], groupuscule néofasciste post-Bastion Social). Ces échanges datent d'octobre 2025. Némésis propose ses militantes comme "appâts" ("on peut faire l'appât et on ne revendiquera pas Némésis"), planifient 8-10 "gros bras" cachés dans un bar prêts à "casser tout". La mort de [[Quentin Deranque]] le 14 février 2026 s'inscrit directement dans cette logique.
...
5. **Responsabilité médiatique** : l'Action Française elle-même a reconnu que Némésis avait "été la cause" de la mort de Quentin. Mais c'est la FI qui est accusée dans les médias. Mécanisme classique d'inversion agresseur/agressé amplifié par la couverture médiatique.

6. **PaduTeam défie Némésis** : la PaduTeam invite explicitement Némésis à les poursuivre en justice si les conversations sont "hors contexte". "On vous attend en procès."

## Chronologie des faits

| Date | Événement |
|------|-----------|
| Octobre 2025 | Conversations Ornela/Calixy sur les guet-apens |
| 14 février 2026 | Mort de Quentin Deranque à Lyon |
| 22 février 2026 | *L'Humanité* publie les conversations |
...
## Enjeux avancés
[[Antiféminisme identitaire comme menace]] — vidéo centrale du corpus : preuve documentaire du guet-apens, distinction conceptuelle fémonationalisme/féminisme raciste, défi judiciaire à Némésis.

...
aliases: ["@Dr_Zoé_YT DÉTRUIT THAÏS D'ESCUFON, ZEMMOUR, DEPARDIEU, ALICE CORDIER, SUR LES VSS !!"]
date created: Monday, April 13th 2026, 12:00:00 am
date modified: Wednesday, April 15th 2026, 1:40:00 pm
---
#domaine/société #thème/féminisme #thème/VSS #thème/médias-propagande
...
1. **Les VSS sont un fait social, pas une exception** : 94% des plaintes sont classées sans suite. 75% des VSS sont commises par des proches (connaissances, famille). L'inceste et le viol conjugal représentent la grande majorité des cas. Ce n'est pas un problème "importé".

2. **La culture française est pétrie de culture du viol** : [[Gerard Depardieu]] avoue un viol en 1977 dans un livre qu'il vend partout ; Benoît Jacot est condamné mais fait toujours la une ; [[Eric Zemmour]] en 2014 justifie le harcèlement de rue. Ces hommes sont blancs, français, et jouissent d'impunité totale. Aller chercher "les étrangers" comme principale explication est du foutage de gueule.

3. **[[Systeme du silence]] comme mécanisme** : [[Thais d'Escufon]] affirme que 90% des accusatrices mentent. Cette affirmation est statistiquement fausse mais produit un effet réel : moins de victimes osent porter plainte → moins de condamnations → plus d'impunité pour les agresseurs → "du sang sur les mains". C'est une chaîne causale directe.
...
| Statistique | Chiffre |
|-------------|---------|
| Plaintes classées sans suite | 94% |
| VSS commises par des proches | 75% |
| Fausses déclarations estimées | 2-8% (consensus scientifique) |
| Chiffre Thaïs d'Escufon | "90% mentent" (faux) |

## Individus mentionnés
[[Dr Zoe]], [[Padu]], [[Thais d'Escufon]], [[Alice Cordier]], [[Eric Zemmour]], [[Gerard Depardieu]], [[Jean-Marc Morandini]]

## Organisations mentionnées
[[Collectif Nemesis]]

## Concepts mobilisés
[[VSS comme fait social]], [[Systeme du silence]], [[Feminisme raciste]], [[Femonationalisme]]

## Enjeux avancés
[[VSS comme fait social]] — vidéo fondatrice du corpus VSS ; établit les bases épidémiologiques et la réfutation de l'explication raciale par les données françaises.

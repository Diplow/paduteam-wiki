...
## Profil synthétique
Streamer/YouTubeur qui a réagi au [[Graphique]] de la [[PaduTeam]] dans une de ses vidéos. Se présente comme spécialiste de data et adopte une posture d'ingénieur critique face à l'outil. La PaduTeam le classe dans la catégorie des cadres/ingénieurs du Graphique : quelqu'un qui résout des problèmes de manière abstraite sans interroger les rapports sociaux concrets.

## Positions
- Défend une vision binaire 1% bourgeois vs 99% "non-bourgeois", refusant les catégories intermédiaires (petite bourgeoisie, etc.)
- Confond travail et force de travail : pour lui, quiconque travaille est un travailleur, donc un prolétaire
- Utilise des exemples individuels ("j'ai un pote ingénieur qui gagne 2200€") pour contester des tendances statistiques
- Pense que le PS a trahi par choix individuel des dirigeants, pas par détermination de classe

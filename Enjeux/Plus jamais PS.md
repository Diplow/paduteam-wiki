...
## Position PaduTeam
Le [[Parti Socialiste]] est l'ennemi structurel de la [[Gauche de rupture]]. Chaque fois que le PS accède au pouvoir, il applique une politique social-libérale, déçoit les masses, et fait monter le fascisme. La résurgence du PS post-macronisme n'est pas une bonne nouvelle pour la gauche — c'est une menace mortelle.

## Arguments récurrents
- Le PS ne peut appliquer que 5% de son programme parce que sa ligne [[Neokeynesianisme|néokeynésienne]] ménage le capital
- Quand la gauche réformiste échoue au pouvoir, c'est toute la gauche qui est discréditée — le RN en profite ([[Fascisation par echec de la gauche reformiste]])
- Le PS instrumentalise les alliances (NUPES, NFP) pour reconstruire sa base électorale, puis poignarde ses partenaires dans le dos
- L'arnaque PS à Toulouse (municipales 2026) est le cas d'école : le PS a préféré faire perdre la gauche plutôt que de laisser gagner un maire LFI
- [[La politique n'est pas de l'arithmetique]] : avoir une majorité arithmétique à gauche ne sert à rien si le PS sabote de l'intérieur
- Le PS sélectionne des carriéristes et purge les militants combatifs : Guedj (ex-bras droit de Mélenchon resté au PS pour une carrière) et [[Marc-Antoine Jamet]] (LVMH + 22 postes + élu PS) incarnent la même logique de captation personnelle du politique. La purge de la JC Nord-92 pour avoir défendu la Palestine confirme le mécanisme
- Faure est une girouette structurelle : il adopte les positions FI après les avoir critiquées, prouve qu'il n'a pas de programme propre. "Ce n'est pas la girouette qui tourne, c'est le vent." Cette dépendance confirme que le PS est parasitaire, pas concurrent idéologique
- La ligne "Mélenchon soft" (Faure post-congrès de Nancy) n'est pas une convergence idéologique — c'est une tentative de fracturer la FI pour en récupérer l'aile droite, confirmant que le PS cherche à affaiblir la gauche de rupture, pas à l'unir
- Le bilan Hollande est la preuve empirique ultime : CICE (300M€ à Arnault sur les cotisations sociales), loi El Khomri, accouchement de Macron — "Nous t'en voudrons jusqu'à la fin de nos vies. Tu as fini de tuer la gauche." La condescendance de classe se lit jusque dans le regard bourgeois sur les maisons ouvrières depuis la fenêtre de sa maison secondaire

## Concepts associés
[[Guerre des gauches]], [[Neokeynesianisme]], [[Fascisation par echec de la gauche reformiste]], [[Gauche de rupture]], [[La politique n'est pas de l'arithmetique]], [[Bloc bourgeois]], [[Neoliberalisme]]

## Adversaires de cette position
Les partisans de l'unité de la gauche à tout prix (Ruffin, une partie du PCF, les "gauches plurielles"). Ceux qui pensent qu'un gouvernement PS imparfait vaut mieux que la droite. Les médias qui présentent le PS comme la gauche "raisonnable" face aux "extrêmes" de LFI.
...
**[[Marine Tondelier]] comme cas d'école EELV** (trois vidéos, [[MARINE TONDELIER SE RIDICULISE FACE A LUMI]], [[DR ZOE CANCEL POSITIONS REVUE POUR MISOGYNIE SUR TONDELIER]] et [[MARINE TONDELIER CATASTROPHIQUE sur FRANCE INTER]]) : elle ne sait pas ce qu'est le capitalisme, ne sait pas ce qu'il faudrait mettre à la place, masque cette inconsistance théorique par la condescendance de classe ("branler la nouille avec des concepts"). Elle croit sincèrement être une figure de la lutte des classes — c'est son privilège de classe, pas sa ruse. La PaduTeam : "C'est une grosse libérale capitaliste qui le croit pas elle-même." Ce mécanisme — la gauche réformiste qui s'approprie un territoire politique (l'écologie, le socialisme) sans rupture avec la propriété — est exactement le même que le PS. Sur France Inter, elle inclut explicitement Macron parmi les antifascistes, réduit tous les désaccords politiques à des "problèmes d'ego", et donne ainsi "le tapis rouge pour le fascisme." Prévision PaduTeam : 3-4% à la présidentielle 2027, seul moyen pour l'appareil EELV de survivre financièrement via le remboursement de campagne.
...
## Le 49.3 Macroniste : la prophétie confirmée (janvier 2026)

[[LE PS SCANDALEUX! ILS ACCEPTENT LE 49.3 MACRONISTE]] est la confirmation en acte de la thèse centrale : le PS avait conditionné sa non-censure du PLFSS à la promesse que le gouvernement ne recourrait pas au 49.3 sur le budget général. Le gouvernement Lecornu a utilisé le 49.3 exactement comme prévu. [[Olivier Faure]] avait posé deux conditions (accès à la copie finale, garanties de ne pas faire payer les Français) — ni l'une ni l'autre n'a été remplie. Résultat : il ne censure pas quand même.

La PaduTeam avait prévu ce scénario depuis des mois, le lit comme une confirmation de la prophétie graphique. [[Francois Hollande]] est identifié comme le vrai architecte : il connaissait la copie du budget plusieurs jours avant Faure, et avait toujours été ouvert au 49.3. Sa déclaration publique "pourquoi ne pas laisser passer ce budget ?" referme en même temps la primaire de gauche en excluant LFI.

**La mort politique d'Olivier Faure** : la PaduTeam le déclare "mort dans le film" — fin de carrière. L'aile droite du PS ([[Jerome Guedj]]) reprend immédiatement le lead en retournant la responsabilité du 49.3 contre LFI ("ceux qui ont refusé de dialoguer").

**Boris Vallaud "la mort dans l'âme"** : assume la non-censure en se félicitant d'un "slip mouillé" — quelques ménages toucheront un peu plus en fin de mois. La PaduTeam fait la liste de ce que le PS présente comme gains : non-dégradations de l'existant (pas de doublement des franchises médicales, pas de réforme de l'assurance chômage), pas de progrès. Le budget contient néanmoins 7 milliards de coupes dans les collectivités territoriales.

## Conférence "Plus jamais PS" (février 2026)
Conférence avec trois intervenants, annoncée dans [[LE PS SCANDALEUX! ILS ACCEPTENT LE 49.3 MACRONISTE]] :
...
[[MUNICIPALES PHILIPPE MARTINEZ SOUTIENT LE PS FACE A LFI]] apporte une preuve supplémentaire : le PS se régénère non seulement via les élections locales mais via des figures syndicales légitimantes. [[Philippe Martinez]], ancien secrétaire de la [[CGT]] qui s'est battu contre les politiques socialistes (loi travail, réforme des retraites), finit à soutenir une liste PS en excluant la [[France Insoumise|FI]]. "Ce qu'il fait quand il a la retraite, c'est soutenir le Parti socialiste. Le mec, tu te dis c'est un traître."

La PaduTeam pose le mécanisme général : quand Martinez soutient des mairies PS qui appliquent des politiques libérales, il leur permet de "capter des ressources, d'implanter des fédérations" — ce qui reconstruit le PS localement bien plus efficacement qu'une alliance verrouillée. "C'est pas neutre. C'est pour ça que nous on fait pour les municipales plus jamais PS."

## Les municipales 2026 comme preuve empirique absolue
La PaduTeam déclare la campagne "Plus jamais PS" "la campagne la plus réussie des municipales 2026". Les résultats city par city confirment la thèse : partout où PS et LFI s'allient, il manque des voix (Toulouse : 5000 voix disparaissent entre 1er et 2e tour), le vote utile crée de la confusion, l'électorat PS du centre part à droite. LFI gagne quand il est seul, perd quand il est avec le PS. Le PS gagne quand il est seul contre le centre. L'union fait perdre les deux.
...
**La formule parfaite du PS devant le mouvement social** : le soir du 10 septembre, le porte-parole PS Arthur de la Porte déclare sur plateau qu'il "ne soutient pas les blocages qui empêchent les gens d'aller travailler." La PaduTeam condense le mécanisme en une formule définitive : **"Le PS soutient les blocages, mais pas si ça bloque. Un blocage qui bloque pas, ça peut aller au Parti Socialiste."** C'est la cohérence profonde avec toute leur histoire : ils ont inventé "le socialisme qui n'est pas socialiste." Structurellement identique à Retailleau et Wauquiez dans ses effets — envoyer les flics — avec un vernis de compassion de gauche pour justifier l'ordre bourgeois. Ce n'est pas une erreur tactique ; c'est la ligne.

## L'aile droite PS et l'option Cazeneuve (septembre 2025)

[[Laurent Baumel]] déclare envisager [[Bernard Cazeneuve]] comme PM de transition en remplacement de Bayrou. Pôle pressenti : Glucksmann + Hollande + Nicolas Mayer-Rossignol + Laurence Rossignol. La PaduTeam : "C'est un coup tentable. C'est vraiment un coup dégueulasse." Et : "Si vous arrivez à faire ça, ce sera votre bilan : vous avez sauvé Macron 2 ans."

## L'aile droite PS assume l'affrontement frontal
La capsule Bouamrane montre l'aile droite du PS qui ne cherche plus à dissimuler sa stratégie : "on va te défoncer". Bouamrane assume que le PS ira seul à la présidentielle, sans alliance avec LFI. Analyse PaduTeam : "ils savent très bien que là on va vers un affrontement entre le PS et la FI. Et peu importe qui va gagner." Le PS n'est plus dans la tambouille molle — il embrasse frontalement la guerre des gauches.
...
- **Ancrage sociologique assumé** : Glucksmann « a dit une fois qu'il est plus chez lui à New York que quand il se promène en France, et il se sent plus chez lui aussi en Géorgie ». Formulation PaduTeam : « eux c'est vraiment la gauche américaine démocrate c'est-à-dire libéral, libéral condescendant, pas même social »[^usa_gluck].

**Le curseur américain** : la PaduTeam affine. AOC et Sanders, présentés en France comme « dingos », sont en réalité modérés ramenés au centre de gravité français. [[Jill Stein]] est parfois comparée à Mélenchon — la PaduTeam corrige : son programme ressemble plutôt à celui de Manon Aubry. **L'aile droite programmatique de LFI vaut mieux qu'une aile gauche du PS ou des Verts** — « le centre de gravité intellectuel est plus fin » côté français. Conséquence : il n'y a pas besoin de « s'élargir au centre » à la Glucksmann ; la bataille est à mener *à gauche* de LFI, vers la radicalité DSA, pas à droite vers Glucksmann/Harris.

### Faure « Mamdani serait au PS » — la danse du ventre au centre démasquée

Au lendemain de la victoire [[Zohran Mamdani]] à NYC (nov 2025, 50% au 1ᵉʳ tour contre Cuomo), [[Olivier Faure]] dégaine la ligne de défense PS : « il se revendique socialiste [...] il veut faire le blocage des loyers dans une zone tendue ». La PaduTeam démonte phrase par phrase :
...
- [[LE PS SCANDALEUX! ILS ACCEPTENT LE 49.3 MACRONISTE]] — confirmation en acte de la prophétie graphique : le PS valide le 49.3 sur le budget général après avoir conditionné sa non-censure à son absence. Faure déclaré "mort dans le film". Hollande révélé comme vrai architecte de la situation (connaissait la copie avant Faure). Annonce de la soirée publique "Plus jamais PS" du 20 février 2026.
...
[[Olivier Faure]] tente de se faire nommer PM par Macron lui-même. Le budget PS présenté est de l'[[Hollandisme]] : retraite à 62 ans (pas 60), baisse de la CSG sur les salaires (mécanisme qui fait payer les cotisants), taxe Zucman symbolique à 2%. Les 900€/an promis aux familles équivalent à 75€/mois — 5% du SMIC. L'aile droite PS ([[Laurent Baumel]]) n'écarte plus l'option Cazeneuve comme PM de transition avec des "engagements solides". Le PS produit exactement le scénario prédit : "Vous avez sauvé Macron, ce sera votre bilan."

Tondelier ([[Europe Ecologie Les Verts]]) opère la même fonction de refroidissement depuis son flanc : arrive avec des aimants sur BFM TV pour présenter les désaccords PS/LFI comme un problème d'angle ou d'ego, dépolitise la situation, travaille objectivement à ramener le mouvement vers des coalitions gouvernementales. La PaduTeam la qualifie de "Marine Macron" — même résultat politique, avec en plus l'hypocrisie de se présenter comme unitaire. Cecile Duflot ([[Oxfam France]]) joue le même rôle depuis l'extérieur du champ partisan : prétend que dénoncer les ultra-riches fait voter RN, masquant le vrai problème (l'absence de perspective de classe).

Face à cette coalition de refroidisseurs, [[Mathilde Panot]] (FI) tient la ligne : "je vous confirme que nous n'accorderons pas de confiance à un gouvernement qui ne porte pas le programme de rupture." La FI censurera tout gouvernement Faure — ce que la PaduTeam valide comme la seule ligne défendable. La formulation est précise : si Faure suspend la retraite à 64 ans, cela signifie que la rue est assez forte pour obtenir 60 ans — donc cédez le minimum pour ne pas devoir cédez davantage.
...
- [[Chloe Ridel|Chloé Ridel]] sur [[Backseat]] rewriting l'histoire PS sur Palestine, passant de "risque de génocide" (mars 2024) à "j'ai toujours dit génocide" (2025)
...
## Vidéos clés
- [[ONFRAY NAULLEAU ET VALLS DECOUVRENT QU'ILS SONT DE DROITE|ONFRAY, NAULLEAU ET VALLS DÉCOUVRENT QU'ILS SONT DE DROITE !! (avec Dr Zoé)]] — mécanisme de la gauche de droite dans les médias réactionnaires ; trajectoire Clouscard ; fonction de "quota gauche" dans les médias Bolloré
...
- [[LE PEN CONDAMNEE MELENCHON SCANDALISE]] — [[Chloe Ridel|Chloé Ridel]] (porte-parole PS) attaque le communiqué de LFI sur la condamnation Le Pen, illustrant la posture permanente d'opposition du PS à LFI dès qu'une opportunité se présente
...
- [[BORIS VALLAUD N A PAS DIT SON DERNIER MOT]] — Analyse détaillée de la stratégie PS post-municipales 2026, la guerre interne Faure/Vallaud/Mayer-Rossignol, et l'arnaque de Toulouse
- [[Debunk Graphique Bad Mulch]] — Le PS trahit non par choix individuel mais par détermination de classe : ses électeurs (haut-droite du Graphique) ont des intérêts divergents des classes populaires
- [[Faut-il en finir avec le NFP]] — Le PS/[[Place Publique]] est la composante qui tire le NFP vers la bourgeoisie. La PaduTeam propose un [[Strategie du 2012 inverse|2012 inversé]] où le PS a son propre candidat (~16-17%) séparé de la gauche de rupture (~23%) — "que les gens décident au premier tour"
- [[Hollande vs Melenchon 2e tour]] — L'aboutissement ultime de l'enjeu : un 2e tour Hollande/Mélenchon serait le duel final entre la trahison social-démocrate (Hollande = continuateur du [[Bloc bourgeois]], "Poutine" dont Macron était le "Medvedev") et la rupture égalitaire. 30 ans après le congrès de Brest, deux hommes qui se détestent s'affrontent pour le destin de la France.
- [[GLUCKSMANN S'OPPOSE aux BLOCAGES du 10 SEPTEMBRE]] — Baumel/aile droite PS envisage Cazeneuve comme PM de transition macroniste. Formulation PaduTeam : "Vous avez sauvé Macron, ce sera votre bilan."
- [[CES BOURGEOIS SONT EN SUEUR DEVANT LE 10 SEPTEMBRE]] — "le blocage qui ne bloque pas" comme formule définitive de la position PS sur le mouvement social ; démonstration que les trois camps (Retailleau, Wauquiez, PS) aboutissent au même résultat (maintien de l'ordre bourgeois) par des chemins différents ; "convention de DRH"
- [[GLUCKSMANN HUMILIE EN DIRECT PAR UN JEUNE INSOUMIS]] — L'affrontement principal avec la gauche molle : Glucksmann ne tient pas face à un militant de 22 ans, confirmation qu'il ne sera pas candidat. Développement complet de la dialectique "affrontement principal ≠ contradiction principale."
- [[L'ALLIANCE MELENCHON-GLUCKSMANN FAUSSE BONNE IDEE]] — Glucksmann qualifié de "genre de Macron 2017", plus pro-marché que pro-redistribution. L'alliance avec lui ferait perdre à la FI les classes populaires et les abstentionnistes au profit d'un barycentre bourgeois
- [[MELENCHON TONDELIER HOLLANDE DUHAMEL SUITE]] — Campagne PJPS présentée explicitement avec kit de collage et recrutement ; le Festival de la Noisette de Bram comme illustration de la "gauche de gouvernement" incompatible avec la rupture
- [[MUNICIPALES CE QU'IL FAUT RETENIR]] — Validation empirique totale : les alliances PS-LFI font perdre partout, LFI gagne seul. "La campagne la plus réussie des municipales."
- [[MUNICIPALES PHILIPPE MARTINEZ SOUTIENT LE PS FACE A LFI]] — Martinez sur liste PS à Villiers-sur-Marne : démonstration que le PS se régénère via les figures syndicales légitimantes. Analyse du "syndicalisme rassemblé" comme mécanisme de droitisation ; Martinez et Berger comme têtes de pont d'une gauche non-FI en vue de 2027. "Il faut que les mairies PS disparaissent pour pouvoir construire une gauche de rupture."
- [[FAURE (PS) VEUT ETRE PREMIER MINISTRE de MACRON !!]] — Analyse du PS comme roue de secours de Macron. Budget hollandiste. Mathilde Panot confirme la censure FI. Démonstration que Faure est structurellement du côté de la barricade macroniste.
...
- [[L'UNION BANCALE des TRAITRES et de la GAUCHE MOLLE]] — la PaduTeam dit explicitement "ici on est team plus jamais PS" face à la conférence FP2027 qui inclut Hollande/Rousseau dans son orbite. Démonstration que le FP2027 est une tentative PS de reconstruire un véhicule avec des noisettes. Faure analysé comme un joueur de "kit ou double" : minoritaire à 40% seulement à son propre congrès, il n'a qu'une chance de survivre en gagnant la primaire.
- [[CAGE et PIKETTY PREFERENT RUFFIN a MELENCHON]] — Cagé soutient Ruffin (comme elle soutenait Hamon en 2017), illustrant que l'intelligentsia PS supporte toujours le candidat voué à l'échec qui ménage le capital ; track record désastreux du soutien PS aux candidats "raisonnables"
- [[GLUCKSMANN PROVES that RUFFIN IS A FRAUD!!]] — confirmation que la ligne PS (Fort ou Rossignol) est structurellement plus droitière que Faure ; le PS doit aller à droite pour survivre électoralement selon le Graphique ; analyse du congrès PS : toutes les lignes convergent vers l'affrontement avec LFI
- [[BOMPARD OU FAURE QUELLE STRATEGIE CONTRE BAYROU POUR LA GAUCHE]] — cas d'école absolu : Faure révèle en 14 secondes sa stratégie de maintien de Bayrou pour préserver le PS jusqu'en 2027. La seule peur du PS est la dissolution. "Ces gens-là ne veulent pas de censure. Ils veulent que Bayrou continue de rester au pouvoir."
...
- [[GLUCKSMANN EST DEJA FINITO VOICI POURQUOI]] — Glucksmann comme "candidat baudruche" utilisé puis jeté par le PS : il n'a jamais eu un parti cohérent derrière lui. La photo de Pontoise (Hollande + Glucksmann + Cazeneuve) est le piège : le PS met en avant Glucksmann pour qu'il s'écrase, puis reprend l'ascendant via Vallaud. "Le PS ne laissera jamais un non-PS prendre l'espace du centre-gauche."
- [[GLUCKSMANN HUMILIE EN DIRECT PAR UN JEUNE INSOUMIS]] — Glucksmann ne tient pas face à un militant de 22 ans, confirmant qu'il ne sera pas candidat. Le bilan géorgien (60 000 postes de fonctionnaires supprimés, salaire minimum aboli) illustre ce que la "démocratie" social-démocrate signifie concrètement pour les classes populaires. La "double besogne" comme cadre d'évaluation : Glucksmann fait les petites avancées sans le projet global.
- [[AYMERIC CARON PURGE DE LFI ON FAIT LE POINT]] — lancement de la campagne "Plus jamais PS" en fin de vidéo. La purge de Caron illustre en creux pourquoi LFI refuse la féodalisation : c'est la même mécanique qui a produit les fiefs PS dont la PaduTeam veut qu'on ne revienne jamais.
...
- [[HOLLANDE prepare t-il SON RETOUR]] — Lancement officiel de la campagne physique "Plus jamais PS" avec kits d'affichage, groupes "On ne veut plus", annonce d'un événement IRL à Paris en février ; formulation de la "loi accélérationniste" qui fait d'Hollande un accélérateur du fascisme malgré son discours antifasciste ; Hollande démontré comme "parrain de la gauche sociale-démocrate" depuis 20 ans, avec Faure comme "valet fantoché" ; Philippe Aghion (conseiller de Macron, théoricien du ruissellement) à la convention Hollande comme signature de classe explicite
...
- [[SURPRISE LE PS TRAHIT ET S'ALLIE AVEC LES MACRONISTES]] — Décryptage du 49.3 de compromis : formule inventée par Hollande, relancée par Rachid Temal et Boris Vallaud pour torpiller la stratégie Faure. Biographie de classe d'[[Amelie de Montchalin]] (HEC, BNP, AXA, Young Leader CIA classico) comme "expression même de l'ennemi de classe". Faure et Montchalin parlent mot pour mot le même langage de "gravité budgétaire". "Quand il n'assume pas la conflictualité, tu te retrouves tous à poil, tout mouillé dans la cave."
- [[LE PS et LES ECOLOS sauvent le BUDGET CATASTROPHIQUE de MACRON]] — Démonstration en acte finale : PS (90% abstentions) et aile droite EELV sauvent le PLFSS 2026, un budget qui : gèle l'ONDAM à 2,1% alors que les dépenses de santé croissent à 4% (équivalent d'une baisse réelle), ne supprime pas la réforme à 64 ans (décalage de 3 mois seulement pour les nés 1964-1978), crée un congé naissance ingérable pour les classes populaires (70% puis 60% du salaire). La "zumba du PS" sur les retraites nommée comme telle. Le PS sauve le budget pour sauver Faure pour sauver la primaire 2026 pour éviter que Hollande reprenne la main. Preuve chiffrée : 13 voix d'écart — les 26 abstentions Verts auraient suffi à le faire tomber si elles avaient voté contre.
...
- [[GLUCKSMANN ADORE LA DEMOCRATIE SAUF A PLACE PUBLIQUE]] — Glucksmann pratique l'autocratie dans son propre parti tout en se présentant comme défenseur de la démocratie ; prophétie graphique confirmée : PP (centre-gauche, petite bourgeoisie cultivée) ne peut pas construire de démocratie de masse
- [[GARRIDO SES METHODES HONTEUSES POUR REGLER SES COMPTES AVEC LFI]] — Garrido et Simonet incarnent la trajectoire type du ralliement noisette au PS : règlement de comptes médiatique sur T18 (chaîne Kretinski/Franc-Tireur), discours islamophobe qualifié de "serpillère", Simonet en route pour rejoindre l'union PS-Verts-PCF à Paris ; annonce et présentation de la campagne "Plus jamais PS" et de l'événement public (Bouamama, Da Silva, Palombarini)
- [[FAURE VEUT FAIRE DU MELENCHON SOFT]] — démonstration graphique que Faure est structurellement une girouette : il copie les positions FI (le mot "génocide" sur Gaza) après avoir été réélu, sans programme propre. "Ce n'est pas la girouette qui tourne, c'est le vent." Projection 2027 : échec de la ligne Fort, désignation de [[Boris Vallaud]] comme candidat PS par défaut.

...
# VSS comme fait social

## Position PaduTeam

Les violences sexistes et sexuelles (VSS) ne sont pas des actes de monstres isolés — c'est une production systémique de la société patriarcale. "Le violeur est un fils sain de la société patriarcale." (citation appréciée par Zoé) L'enjeu politique est d'inscrire les VSS dans une analyse structurelle, pas individuelle, et de montrer que la réponse pénale ("violeur étranger dehors, violeur français en prison toute la vie") ne règle rien.
...
Les discours qui minimisent les VSS ("90% des femmes mentent" — Thaïs d'Escufon, "elle la cherchait" — droitards commentant les manifs Némésis) participent directement au système du silence :
- Ils augmentent la honte des victimes
- Ils réduisent les dépôts de plainte
- Ils perpétuent l'impunité
- "Quand tu légitimes le viol conjugal, tu as un peu du sang sur les mains"

## La réponse pénale ne suffit pas

Même quand les victimes portent plainte :
- 94% classées sans suite
- Les rares procès sont traumatisants (affaire Pelicot : les avocats de la défense maltraitent les victimes)
- La preuve est quasi impossible à rapporter pour les viols par connaissance (parole contre parole)
- Exception : les crimes en série avec de nombreuses victimes indépendantes

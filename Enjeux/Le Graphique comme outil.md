...
- [[LE PEN DÉCLARE la GUERRE à BARDELLA !!]] — les prophéties du Graphique se réalisent une à une : scission Le Pen/Bardella prédite (deux lignes irréconciliables, deux carrières incompatibles), les 42-40-18 des législatives, la diabolisation de Mélenchon, les deux gauches. "Tout va plus vite que prévu." Prévision : si Bardella est candidat RN à la place de Le Pen, il fera 15-16% (Retailleau 18-19%) — Bardella ne capte ni l'espace populaire (Le Pen) ni la bourgeoisie (Retailleau)
- [[MARINE TONDELIER CATASTROPHIQUE sur FRANCE INTER !!]] — EELV positionnée en "haut milieu" du Graphique ; ses ZFE et bonus écologiques montrent exactement où EELV se situe sociologiquement ; prévision : 3-4% à la présidentielle
- [[Les INCELS ont ENFIN leur SAINT GRAPHIQUE !!]] — le titre joue sur la terminologie PaduTeam : Marc a construit son propre "Saint Graphique" (tableur avec axes et courbes) pour optimiser le coût des rapports sexuels. Contrepoint ironique qui révèle par contraste ce que fait le Graphique PaduTeam : rendre visible une totalité sociale, pas réifier des individus

---
name: TODO — Batches d'ingestion à planifier
description: Liste des batches thématiques identifiés à partir de l'inventaire PaduTeam, hors vidéos déjà ingérées et hors périmètre GÉOPOLITIQUE.md
date created: 2026-04-13
---
# TODO — Batches d'ingestion à planifier

Batches identifiés à partir des titres non encore ingérés de l'inventaire PaduTeam. Les batches GÉOPOLITIQUE (Iran, Venezuela, Ukraine/bellicisme) sont suivis séparément dans `GEOPOLITIQUE.md`.

---

## Santé & Sécurité sociale

Deux sous-batches naturels autour de Zoé et Padu. Angle : le système de santé comme terrain de lutte de classes.
...
## Lutte des classes / Patronat / Milliardaires

Grille matérialiste appliquée aux riches, au patronat et à leurs alliés médiatiques.

### Batch CLASSE-A — Milliardaires & patronat

**Statut** : en attente
**Slug branche** : `ingest-batch/milliardaires-patronat`
...
- [ ] LES BOURGEOIS PARTENT EN VACANCES À COURCHEVEL POUR SEULEMENT 60 000€ LA SEMAINE !!
- [ ] LA PIRE HUMILIATION DEVANT DES PATRONS : LE DÉFILÉ DES PAUVRES
- [ ] CHARLES CONSIGNY VEUT + D'ESCLAVES POUR LES VENDANGES !!
- [ ] Un INCONNU ASSASSINE le PDG de la + GROSSE ASSURANCE SANTÉ des USA (X Dr Zoé)
...
### Batch CLASSE-B — Petite-bourgeoisie & travail

**Statut** : en attente
**Slug branche** : `ingest-batch/petite-bourgeoisie-travail`

- [ ] TATIANA : CONSULTANTE EN BULLSHIT DE DROITE (partie 1 avec Positions Revue)
- [ ] TATIANA VEUT QUE LES GUEUX RETOURNENT À L'USINE !! (react partie 2 avec Positions Revue)
...
Critique systématique des médias dominants. Deux angles : les propagandistes réactionnaires, et les faux-progressistes.

### Batch MÉDIAS-A — Chiens de garde réac (CNews, TPMP, TF1…)

**Statut** : en attente
**Slug branche** : `ingest-batch/medias-chiens-de-garde`

- [ ] 10 SEPTEMBRE : LES GRANDES GUEULES FONT LES CHIENS DE GARDE !
- [ ] Ce JOURNALISTE de FRANCE INTER PÈTE UN CÂBLE face à MANON AUBRY !! (ALI BADDOU)
- [ ] NATHALIE SAINT-CRICQ PRISE EN FLAGRANT DÉLIT DE PROPAGANDE ANTI-MÉLENCHON !!
- [ ] SONDAGES DE PROPAGANDE SUR FRANCE INFO : ÇA DEVIENT N'IMPORTE QUOI !
- [ ] PASCAL PRAUD DÉNONCE LE RACISME SUBI PAR AYA NAKAMURA !!
- [ ] CNEWS PÈTE UN CÂBLE SUR KARIM BENZEMA !!
...
### Batch MÉDIAS-B — Faux-progressistes (Marianne, France Inter, Viktorovitch…)

**Statut** : en attente
**Slug branche** : `ingest-batch/medias-faux-progressistes`

- [ ] MARIANNE : le journal NÉGA-SIONNISTE !
- [ ] MARIANNE M'ANALYSE POLITIQUEMENT AVEC USUL ET DANY ET RAZ : CA TOURNE MAL !!
- [ ] CHAPOUTOT DÉTRUIT MARIANNE EN LIVE : ILS SE VENGENT !!
- [ ] VIKTOROVITCH VS PADUTEAM : QUI ANALYSE MIEUX LA MONTÉE DU FASCISME
- [ ] CLÉMENT VIKTOROVITCH : LA JEUNESSE COMMUNISTE UTILISE DES MÉTHODES FASCISTES !!
...
## Mouvement social / 10 septembre / Grève générale

Le bloc des mobilisations sociales 2025 — gilets jaunes, 10 septembre, 18 septembre. Événementiel mais analytiquement dense.

### Batch MOUVEMENT — Le 10 septembre et ses suites

**Statut** : en attente
**Slug branche** : `ingest-batch/mouvement-social-10-septembre`
...
## PCF & gauche radicale hors LFI

Le PCF qui dérive — du communisme au libertarianisme, en passant par les alliances avec le PS. Complément naturel du thème "Plus jamais PS".

### Batch PCF — La dérive du PCF et de la gauche radicale

**Statut** : en attente
**Slug branche** : `ingest-batch/pcf-derive-gauche-radicale`
...
## Théorie marxiste & formation politique

Vidéos à vocation pédagogique : le marxisme lui-même, contre les débunks réactionnaires et les dérives théoriques.

### Batch THÉORIE — Marxisme, matérialisme, formation

**Statut** : en attente
**Slug branche** : `ingest-batch/theorie-marxiste-formation`

- [ ] LÉNINE, TOUJOURS VIVANT (avec Positions Revue)
- [ ] LUCIEN SÈVE : une PSYCHOLOGIE MARXISTE est-elle POSSIBLE (Éditions Sociales X Benoit Lepinat)
- [ ] RELIGIONS et ATHÉISME (analyse MARXISTE avec POSITIONS REVUE)
- [ ] BÉGAUDEAU se RIDICULISE sur le DÉTERMINISME et le MARXISME !!
- [ ] MOS MAJORUM : ce sont LES SALARIÉS qui EXPLOITENT LES PATRONS !! (avec Chris)
- [ ] MOS MAJORUM croit DÉBUNKER MARX : ça TOURNE très très MAL !! (avec Chris)
- [ ] ONFRAY DÉBUNK DÉFINITIVEMENT LE COMMUNISME !!
- [ ] Le RN et la DROITE ATTAQUENT les COMMUNISTES et leurs 100 MILLIARDS DE MORTS !!
...
## Question agraire / Ruralité / Paysannerie

Qui sont les paysans dans la grille de classe ? Alliés potentiels ou base sociale du RN ?

### Batch AGRI — La question paysanne

**Statut** : en attente
**Slug branche** : `ingest-batch/question-paysanne`

- [ ] AGRICULTEURS : CAMARADES ou ENNEMIS DE CLASSE (analyse marxiste avec Positions Revue)
- [ ] LES PAYSANS SONT-ILS NOS CAMARADES ?
- [ ] RÉVOLTE AGRICOLE : la CONFÉDÉRATION PAYSANNE peut CHANGER LES CHOSES !
- [ ] THOMAS GIBERT, SECRÉTAIRE NATIONAL DE LA CONFÉDÉRATION PAYSANNE, RÉPOND À MES QUESTIONS EN LIVE !!
- [ ] BAPTISTE MARCHAIS DÉFEND MCDONALD'S FACE AUX AGRICULTEURS !!
- [ ] PINARD et POLITIQUE : la DROITE DES LOBBYS vs la GAUCHE DU TERROIR (X Dr Zoé) !!
...
## Trump & gauche américaine

Trump vu comme révélateur systémique + émergence d'une gauche américaine radicale (Mamdani). Articulable avec les batches GÉOPOLITIQUE ou autonome.
...
- **Ordre recommandé** : SANTÉ → CLASSE → MÉDIAS → MOUVEMENT → PCF → THÉORIE → AGRI → USA
  - SANTÉ pose Zoé comme figure analytique sur un terrain concret
  - CLASSE fournit le vocabulaire de la grille matérialiste (enrichit Graphique, Choc d'abondance)
  - MÉDIAS et MOUVEMENT sont événementiels, plus accessibles
  - PCF et THÉORIE sont plus denses, bénéficient des concepts posés avant
  - AGRI et USA sont plus autonomes, peuvent passer à n'importe quel moment
- **Batches GÉOPOLITIQUE** suivis séparément dans `GEOPOLITIQUE.md` (Iran, Venezuela, Ukraine/bellicisme)
- **Féminisme / transphobie** : batches en cours sur branche `theme/feminisme`, ne pas dupliquer
- **Taille des batches** : tous entre 6 et 9 vidéos — dans les limites acceptables, pas de scission nécessaire sauf SANTÉ (déjà scindé en A+B) et MÉDIAS (déjà scindé en A+B)

...
domaine: [théorie]
thèmes: [travail]
aliases: [abstrait au concret, méthode du Capital]
...
## Définition
Méthode fondamentale du *Capital* de [[Karl Marx]], opposée à l'empirisme. Au lieu de partir d'observations concrètes pour en déduire des lois abstraites (approche "aristotélicienne" ou positiviste), Marx part de grandes abstractions (travail, valeur, prix, marchandise, fétichisme de la marchandise) qui permettent ensuite de "s'élever au concret" — c'est-à-dire de comprendre la réalité dans sa totalité.

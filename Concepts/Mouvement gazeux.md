...
## Définition
Métaphore critique désignant un mouvement politique non structuré, diffus, qui se disperse sans laisser de forme solide. La PaduTeam l'applique principalement à [[France Insoumise|LFI]] pour décrire son manque de structuration interne, de militantisme organisé, et d'ancrage dans des structures associatives durables.

## Mécanisme
Un mouvement "gazeux" est :
- Centré sur la personnalité d'un leader plutôt que sur des structures collectives
- Incapable de mobiliser durablement hors des moments électoraux
- Sans mécanisme de formation politique des militants
- Vulnérable à la répression (pas de protection juridique collective, pas de fédération d'organisations)

La PaduTeam oppose le "mouvement gazeux" à la "condensation" : la formation de structures associatives denses, de fédérations, de réseaux de militants ancrés dans leur milieu professionnel.

## La réponse : condensation
La Brèche et le projet de fédération qu'elle porte sont explicitement conçus comme une réponse à ce déficit. L'analogie physique (gaz → liquide → solide) illustre la progression souhaitée du mouvement de gauche.

## Exemples
- LFI critiquée pour son "côté gazeux" au détriment d'une structuration partisane solide
- La Brèche comme tentative de "condensation" à leur échelle
...
[[Stathis Kouvelakis]] dans La Brèche approfondit le diagnostic. Il ne faut pas se contenter de "candidatures emblématiques" dans des circonscriptions déjà acquises (ex: Ali Douar dans le 93) — même si c'est bien. Le vrai travail est plus organique :

- **Reconstruire le maillage social** : s'insérer dans les associations, conseils d'administration, réseaux locaux. Le PS des années 70 avait intégré les CA des associations d'œuvres laïques, les CA d'écoles publiques, les syndicats (CFDT notamment) — ce tissu a permis la victoire de 1981.
- **Victoires municipales comme étape** : la victoire municipale de 1977 a permis de montrer que "la transformation sociale et le programme commun, ce n'est pas l'écharpe rouge sur l'assemblée" — étape cruciale d'assimilation du programme de rupture par des technostructures administratives locales.

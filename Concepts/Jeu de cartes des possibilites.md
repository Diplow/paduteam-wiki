...
- Ces habitudes distribuent constamment des cartes aux individus selon leurs positions dans les sujets collectifs (classe, genre, race, nation, génération, etc.).
- Un individu n'est jamais recouvert que par **un seul** sujet collectif — il est à l'intersection d'une multiplicité (classe + genre + race + métier + génération...).
- Chaque position distribue des cartes différentes. Un homme a la "carte" de rire d'une femme sans les mêmes conséquences — cette carte existe dans le jeu, mais il peut choisir de ne pas la jouer.
- Les cartes d'un sujet collectif peuvent être "compensées" ou rendues inactives par les cartes d'autres sujets collectifs plus fonctionnels (ex : militantisme prolétaire qui rend inactive la carte de domination masculine).

## Immanence du jeu
Le jeu est redistribué en permanence : on n'arrive pas à "la table" avec les cartes accumulées de toutes ses parties précédentes. Ce qui compte, c'est la position *actuelle*. C'est pourquoi un ouvrier devenant patron pense comme un patron dès le lendemain — le jeu change instantanément.

## Application : pourquoi tous les hommes ne violent pas

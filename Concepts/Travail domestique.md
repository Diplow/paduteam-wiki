...
## Définition
Ensemble des tâches liées à l'entretien du foyer et au soin des personnes (enfants, personnes âgées, malades) : ménage, cuisine, lessive, courses, garde d'enfants, allaitement, gestion administrative. Dans l'analyse de la PaduTeam, c'est un **travail réel, indispensable, sous-valorisé et massivement féminisé** — ni "naturel", ni "facile", ni sans qualification.
...
## Solution communiste
La PaduTeam refuse la solution individuelle (chaque bourgeois doit "faire un effort"). La solution est organisationnelle : dans le communisme, l'accumulation différentielle de capital est impossible, donc personne ne peut "utiliser" quelqu'un d'autre pour se libérer du travail domestique. La libération passe par la distribution collective du travail restant à tout le monde — y compris via la robotisation des tâches les plus pénibles.

## Exemples
- La nanie ougandaise de [[Yasuk]] : 700€/mois, séparée de ses propres enfants, entière disponibilité
- Les caissières : emploi pénible (TMS, horaires) que la PaduTeam veut supprimer par automatisation — mais au profit des travailleuses, pas du capital
- Les lavendières : supprimées par la machine à laver, c'était positif (exemple de robotisation légitime)

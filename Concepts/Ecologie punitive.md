...
## Définition
Approche écologique qui répond à la crise environnementale par des contraintes imposées aux individus (taxes, interdictions, normes) sans remettre en cause le mode de production capitaliste. C'est l'écologie des [[Europe Ecologie Les Verts]] et de [[Marine Tondelier]], opposée à l'écologie marxiste que promeut la PaduTeam.

## Mécanisme
Au lieu de planifier la transformation de l'appareil productif, l'écologie punitive :
1. Identifie les comportements individuels comme problèmes (conduire une vieille voiture, chauffage au fioul, avion...)
2. Impose des contraintes/incitations pour les modifier (bonus-malus, ZFE, taxes carbone)
3. Laisse le capitalisme décider des solutions techniques (voitures électriques, marchés du carbone)
4. Résulte en écologie de riches : seuls ceux qui ont les moyens peuvent "se mettre en conformité"
...
Lien avec le [[Malthusianisme]] : l'écologie punitive peut mener à des positions néo-malthusiennes (Yanosvichi en 2019 : "cesser de tout mettre en œuvre pour faire survivre les personnes malades").

## Opposition : écologie marxiste
L'écologie marxiste (PaduTeam) : "L'écologie sans capitalisme, c'est du jardinage." Le problème environnemental est un problème social — ses victimes sont les classes populaires des pays du Sud. La solution est la planification démocratique de l'appareil productif, pas les incitations marchandes.

## Gilets Jaunes
Mouvement parti de l'écologie punitive (hausse de la taxe carbone sur le carburant) — et que la gauche bourgeoises a eu tendance à rejeter comme "pro-essence". La PaduTeam y voit un mouvement de classe populaire rurale victime précisément de l'organisation spatiale capitaliste que l'écologie punitive ignore.
...
- Résultat : la voiture n'est pas un "choix" — c'est "une logique de survie." Pour ceux qui ont arrêté les études tôt et doivent travailler, pas de voiture = pas de travail.

Référence théorique : Henri Lefebvre sur les modes de logistique capitaliste et l'organisation sociale.

...
aliases: [psychologisation, réduction à l'ego]
statut: développé
---
#domaine/politique-intérieure #thème/guerre-des-gauches #thème/élections

# Psychologisation des désaccords politiques

## Définition
Stratégie rhétorique qui consiste à réduire des oppositions politiques de fond (lignes, projets, positions de classe) à des conflits de personnes (ego, ambitions personnelles, rivalités). La PaduTeam l'identifie comme une forme de dépolitisation : en faisant croire que les désaccords sont des problèmes de caractère, on évite de débattre du fond.

## Mécanisme
1. Un désaccord politique réel (ex: Gaza, ZFE, crédits de guerre) opposant deux partis est présenté comme : "ils ne savent pas placer leurs égos en dessous de l'intérêt général."
2. La solution proposée devient psychologique : "soyez raisonnables, faites des concessions", au lieu de : "tranchez la question politique."
...
[[Marine Tondelier]] appelle à l'union de la gauche en disant que [[Jean-Luc Mélenchon]] et [[Raphaël Glucksmann]] ne s'unissent pas à cause de leurs égos. Padu : "Pensez que les oppositions au sein d'un camp politique entre des personnes sont des oppositions d'ego, c'est gommer le fait qu'en réalité derrière les histoires de personnes, il y a des histoires de lignes."
...
- Les ZFE : LFI s'y oppose, EELV les soutient
- Les crédits de guerre : EELV a voté des crédits massifs
- La Palestine : octobre 2023, EELV mal positionné

## Autre exemple : le départ de Corbière, Garrido, Autain

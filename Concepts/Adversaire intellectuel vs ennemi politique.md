...
# Adversaire intellectuel vs ennemi politique

## Définition
Distinction fondamentale de la PaduTeam pour situer les figures et courants par rapport à leur propre position marxiste. Trois catégories :
- **Adversaire intellectuel** : voit le même problème, propose des solutions différentes mais allant dans la même direction (progrès, égalité). C'est un allié politique.
- **Ennemi politique** : voit le même problème mais propose des solutions allant dans une direction opposée (violence, hiérarchie).

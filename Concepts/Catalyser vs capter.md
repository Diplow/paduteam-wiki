...
**Fournis** : l'infrastructure matérielle (affiches, flyers, stickers, logistique d'impression et d'envoi), l'identité visuelle et sémiotique (générateur de visuels onveulplus.fr, mot d'ordre "on ne veut plus"), les outils juridiques (fiches de droits, ce qu'on peut et ne peut pas faire en collant), la continuité organisationnelle (base mail, groupe Telegram, [[Binome paritaire|binômes paritaires]]).
...
## Opposition à la récupération
Dans la tradition militante française, "récupérer un mouvement" est une accusation grave. Capter, c'est ce que font les appareils qui arrivent en AG avec une ligne à faire valider et un candidat à pousser. Catalyser, c'est arriver avec du matos, une base mail et une sortie claire : on dépose, on ne s'installe pas. La PaduTeam assume d'être visible (tout le monde sait que l'initiative vient d'eux), mais pas de s'installer en centre.

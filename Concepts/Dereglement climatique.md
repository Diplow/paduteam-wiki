---
type: concept
domaine: [écologie, géopolitique]
thèmes: [écologie, anti-impérialisme]
...
## Définition
Terme préféré par la PaduTeam à « réchauffement climatique » car plus fidèle à l'hétérogénéité spatiale des effets : certains territoires deviennent inhabitables, d'autres deviennent exploitables. Cette asymétrie géographique n'est pas un effet secondaire — elle est saisie politiquement comme **facteur impérialiste direct**.
...
« Ces territoires là qui sont encore vierges devraient être nous, on pense internationalisés » — position explicite de la PaduTeam. La [[Loi du plus fort]] trumpiste (Groenland, Antarctique, Lune, Mars) se pose comme alternative unique en l'absence d'internationalisation.

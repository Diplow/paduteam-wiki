...
aliases: [l'aufer, lawfare, instrumentalisation judiciaire]
date created: Thursday, April 2nd 2026, 3:19:11 pm
date modified: Wednesday, April 15th 2026, 1:40:01 pm
---
#domaine/politique-intérieure #domaine/géopolitique #thème/répression-justice #thème/élections

# Lawfare

## Définition
Utilisation de l'appareil judiciaire ou institutionnel comme arme politique pour neutraliser un adversaire — sans nécessairement commettre d'irrégularité visible, mais en choisissant qui poursuivre, avec quel timing, et avec quelle sévérité. Le terme est une contraction de "law" (loi) et "warfare" (guerre). Dans le transcript, le terme est phonétiquement transcrit "l'aufer".

## Mécanisme
Le lawfare ne requiert pas forcément que la condamnation soit injuste sur le fond : il suffit que l'opportunisme politique dans le choix des cibles, le calendrier judiciaire, ou l'application différentielle selon les classes et les partis, transforme la justice en instrument de régulation politique. Variantes :

1. **Condamnation + inéligibilité exécutoire immédiate** (sans recours possible avant élection) — cas [[Marine Le Pen]] mars 2026
2. **Annulation de résultat électoral** pour "ingérence étrangère" — cas [[Călin Georgescu]], Roumanie 2024
3. **Condamnation préventive empêchant une candidature** — cas [[Lula]] au Brésil 2018 (opération Lava Jato)

## Analyse PaduTeam
La PaduTeam ne défend pas les actes condamnés (elle reconnaît que Le Pen et le RN ont bien commis les faits reprochés). Ce qu'ils soulignent : la justice n'est pas neutre. Elle applique différemment ses règles selon les partis, les classes, les personnalités. Une jurisprudence qui autorise l'exécution immédiate de l'inéligibilité sans recours peut demain être retournée contre [[Jean-Luc Melenchon]] ou contre toute autre opposition radicale.

La PaduTeam : "On critique nous-même tout le temps la justice sur la façon dont elle s'applique sur les populations les plus marginalisées, les plus dominées. C'est aussi une justice. Bah si elle a pas cette neutralité, elle a aussi pas la neutralité de traiter tous les opposants au régime bourgeois de la même manière."
...
L'arc Rima Hassan illustre la forme la plus aboutie du lawfare : non plus seulement judiciaire, mais couplé à un rouleau compresseur médiatique (ce que la PaduTeam appelle "l'offert"). Structure :
...
2. **Violation de l'immunité parlementaire** : Rima Hassan est eurodéputée. Elle n'est pas censée être convoquée pour chaque tweet. La première chose à dire, répète la PaduTeam : "Elle ne devrait pas être là" — le principe même de la convocation est illégitime avant d'examiner le fond.

...
## Mécanisme
1. L'accroche est **sexiste et misogyne** : Soral promet à ses lecteurs d'apprendre à "pécho" — c'est l'entrée dans le récit, pas la politique. La PaduTeam : "3/4 des gens qui lisent Soral veulent savoir comment pécho."
2. Soral récupère des auteurs marxistes ([[Michel Clouscard]], etc.) en n'en extrayant que ce qui flatte le racisme et le sexisme, en escamotant leur corpus révolutionnaire.
3. Il offre un ennemi de substitution (l'immigré, le "féminisme mondialiste") à la place de la bourgeoisie.
...
La PaduTeam (dans [[FROM TROTSKISTE TO RACISTE]]) : "l'un va pas sans l'autre, l'un se nourrit avec l'autre et vice versa" — le soralisme et la période confuse se co-construisent. C'est pour ça que "depuis 40 ans on n'a pas changé de gouvernement."
...
Le soralisme est aussi un modèle économique : Soral vit de sa boutique idéologique (livres, abonnements, Égalité et Réconciliation), dont les intérêts sont ceux d'un petit propriétaire. Ses positions économiques (défense des petits patrons, méfiance envers la planification) reflètent ces intérêts — c'est du [[Capitalisme boutiquier]] non assumé.

## La soralisation de retour : le cycle Papacito

La vidéo [[PAPACITO ET ROUGEYRON SE LA JOUENT SORAL]] introduit la notion de **soralisation de retour** ou **re-soralisation** : des figures qui avaient quitté Soral vers 2017 pour adopter un national-libéralisme identitaire plus assumé (Reconquête, Leskin, Conversano) se retrouvent en 2024 contraintes de revenir vers la zone confuse soraliste, parce que la [[Moisation|moïsation]] a rendu leur niche intenable.

Le mécanisme en trois temps :
1. **Rupture avec Soral** (2015-2017) : Papacito, le Raptor et d'autres quittent la ligne "gauche du travail, droite des valeurs" de Soral pour un national-libéralisme identitaire plus clairement raciste (soutien à Reconquête, Leskin, Baptiste Marché).
2. **Doublement par la droite** (2022-2024) : l'argent Bolloré finance une nouvelle vague d'influenceurs plus nettement identitaires (Mila, Yan Power) qui rendent la ligne initiale obsolète.
3. **Retour à la confusion soraliste** (2024) : Papacito renoue avec le discours "les vrais hommes peuvent être noirs ou arabes" — c'est-à-dire exactement le Soral de 2015. "Ces mecs se sont séparés d'Alain Soral pour aller vers du libéralisme identitaire, ils sont en train de revenir vers un truc qui ressemble au soralisme de 2015."
